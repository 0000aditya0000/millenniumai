  ...
  const blogPosts = [
    {
      id: 1,
      title:
        "How MillenniumAI is Redefining AI & Web Development with World-Class Quality at Global-Best Pricing",
      excerpt:
        "Discover how MillenniumAI is revolutionizing the global development landscape by offering world-class AI and web development services at competitive pricing that startups and enterprises can't ignore.",
    ...
    },
    {
      id: 2,
      title:
        "The Global Demand for Smart Development: Why AI and Custom Software Are Essential",
      excerpt:
        "Global startups and enterprises are increasingly seeking fast, reliable, and cost-effective development solutions. Learn why AI, custom software, and full-stack web development are in unprecedented demand.",
    ...
    },
    {
      id: 3,
      title:
        "MillenniumAI's Development Philosophy: Quality-First Approach in Action",
      excerpt:
        "Explore our quality-first development philosophy that combines agile methodologies, scalable coding standards, and rapid development cycles without compromising on precision and security.",
      author: "Tech Experts",
      date: "Dec 10, 2024",
      category: "Innovation",
      readTime: "7 min read",
    ...
    },
    {
      ...
      excerpt:
        "How MillenniumAI delivered a secure election dashboard in just 3 weeks with 99.9% uptime, ISO-compliant security, and 40% cost savings compared to European vendors.",
      author: "Project Team",
      date: "Dec 5, 2024",
      category: "Web Development",
      readTime: "5 min read",
    ...
    },
    {
      id: 6,
      title:
        "Why Global Clients Choose MillenniumAI: Affordability, Speed, and Transparency",
      excerpt:
        "Discover the key factors that make MillenniumAI the preferred choice for global clients: up to 60% lower costs, 30-40% faster delivery, and transparent development processes.",
    ...
    return (
      <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center px-4">
        <div className="text-center max-w-md mx-auto">
          ...
          <Link
            to="/blog"
            className="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white rounded-xl font-medium hover:scale-105 transition-all duration-300 text-sm sm:text-base"
          >
      ...
      <div className="relative max-w-[1920px] mx-auto px-4 sm:px-6 py-6 sm:py-8 pt-24 sm:pt-28 lg:pt-32">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6 sm:mb-8">
            <Link
              to="/blog"
              className="inline-flex items-center gap-2 text-gray-300 hover:text-white transition-colors duration-300 group text-sm sm:text-base"
            >
            ...
            <div className="relative bg-white/5 backdrop-blur-sm rounded-2xl sm:rounded-3xl border border-white/10 overflow-hidden">
              ...
              <div className="p-4 sm:p-6 lg:p-8">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10">
                  ...
                  <Link
                    to="/blog"
                    className="inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white rounded-xl font-medium hover:scale-105 transition-all duration-300 text-sm sm:text-base w-full sm:w-auto justify-center"
                  >
