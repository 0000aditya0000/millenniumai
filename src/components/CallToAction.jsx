...
export default function CallToAction() {
  return (
    <section className="w-full bg-[#b07a3c] py-12 flex justify-center items-center relative overflow-hidden">
      ...
      <div className="max-w-3xl text-center relative z-10">
        ...
        <motion.a
          href="#contact"
          className="bg-white text-[#b07a3c] font-bold px-8 py-3 rounded-full shadow-lg text-lg transition-all duration-200 hover:bg-[#f3e7d2] inline-block"
